...
- SHM-EM evidence: `docs/revision/DATA_MODEL_CONTRACT_SPEC.md`, `docs/revision/PROJECT_FUTURE_STATE_ALGORITHM.md`, `docs/evidence/verification/failure-matrix-v2.md`, and `docs/revision/PROVENANCE_TRACE_EXAMPLE.md`.
