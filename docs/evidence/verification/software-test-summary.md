...
| PIT_PRE contract/alignment/integrity tests | 13 | 13 | PASS | `docs/evidence/verification/phase2b-final-regression.json` |
| Validation matrix (P00, F01-F12, I01-I02) | 15 | 15 | PASS | `docs/evidence/verification/failure-matrix-v2.json` |
| Second-configuration end-to-end acceptance | 7 | 7 | PASS | `docs/evidence/verification/phase1b-regression.json` |
| Frontend typecheck and production build | 2 | 2 | PASS | `docs/evidence/verification/phase2b-final-regression.json` |
| Public reference end-to-end reproduction | 1 | 1 | PASS | `docs/evidence/performance/reference/reference-summary.json` |
