...
- `docs/evidence/performance/controlled-ab/` establishes controlled A/B semantic equivalence and absence of material reference regression.
- `docs/evidence/verification/result-set-equivalence.json` and `cross-project-safety.json` establish result-set preservation and corruption detection.
