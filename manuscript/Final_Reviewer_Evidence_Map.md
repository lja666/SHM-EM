...
| R1-1 | Sections 3.2, 4.2; Table 4 | `phase1b-regression.json` and final Git diff | 3 stations; 12 instruments; 1,120 rows; B9-B15 7/7; zero frozen changes |
...
| R1-7 | Section 2.1.2; Table 2 | `MODEL_CONFIG_SUMMARY.md`; model-config JSON | 6 bundles; histories 12-16; inputs 2-50; targets total 124; hash checks pass |
...
| R1-13 | Section 2.1.4; Fig. 3 | Mermaid source; sequence code crosscheck | Evaluate no formal side effects; Execute recomputes/persists Gate |
