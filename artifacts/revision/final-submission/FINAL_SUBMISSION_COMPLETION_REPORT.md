# Final Submission Compliance Correction Report
...
- `SHM-EM_SoftwareX_Revised_Clean.docx/pdf` (13 pages)
- `SHM-EM_SoftwareX_Revised_Marked.docx/pdf` (24 pages with markup shown)
- `Response_to_Reviewers.docx/pdf` (12 pages)
