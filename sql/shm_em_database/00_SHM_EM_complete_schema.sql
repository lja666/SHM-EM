...
CREATE TABLE `em_prediction_batch` (
  ...
  `persisted_output_hash` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `persisted_output_hash_version` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `em_prediction_execution_gate` (
  ...
  `result_integrity_valid` tinyint NOT NULL DEFAULT '0',
...
CREATE TABLE `em_prediction_run` (
  ...
  `message` varchar(512) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `result_hash` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `persisted_result_hash` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `persisted_result_hash_version` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
