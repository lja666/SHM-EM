...
public class PredictionDisplay {
    ...
    private LocalDateTime persistedBaseTime;
    private LocalDateTime persistedFutureTime;
    private BigDecimal predictedValue;
    private String predictedUnit;
    private BigDecimal storedPredictedValue;
    private String storedPredictedUnit;
    ...
    private BigDecimal engineeringLowerBound;
    private BigDecimal engineeringUpperBound;
