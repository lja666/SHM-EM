...
3. The common 164-feature contract is not confused with model-specific inputs (42/42/14/14/2/50), and the 16-step common window is distinguished from 12-16 model histories.
...
6. The validation matrix is counted as P00 + F01-F12 + I01-I02; only cases expected to be blocked are said to have zero formal side effects.
